...
const CATALOG = {
  services: [
    ...
    { id:'s2',  name:'Класичний масаж тіла',               price:900,  time:'1 год 10 хв', img:'assets/images/Знімок екрана 2026-07-14 132337.png',  desc:'Класичний масаж — базова техніка для покращення кровообігу та зняття м\'язової напруги по всьому тілу.', tags:['масаж','класичний','тіло'] },
    ...
    { id:'s4',  name:'Антицелюлітний масаж',               price:900,  time:'1 год',      img:'assets/images/маряна.png',                             desc:'Інтенсивний вплив для корекції фігури та зменшення целюліту. Покращує лімфодренаж.', tags:['масаж','антицелюліт','корекція'] },
    ...
    { id:'s6',  name:'Gummy + Wood масаж',                 price:1000, time:'1 год',      img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'Комбінований комплекс Gummy + Wood масаж — поєднання унікальних технік для максимального результату.', tags:['масаж','комплекс','wood'] },
    { id:'s7',  name:'Масаж обличчя',                      price:800,  time:'1 год',      img:'assets/images/маряна.png',                             desc:'Масаж обличчя — покращення тонусу шкіри, ліфтинговий ефект, розслаблення мімічних м\'язів.', tags:['масаж','обличчя','ліфтинг'] },
    { id:'s8',  name:'Масаж обличчя + ліфтинг маска',     price:1000, time:'1 год',      img:'assets/images/маряна.png',                             desc:'Масаж обличчя з ліфтинговою маскою — подвійний ефект омолодження та підтягування шкіри.', tags:['масаж','обличчя','маска'] },
    ...
    { id:'s10', name:'Лікувально-профілактичний масаж',    price:750,  time:'1 год',      img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'При сколіозі, артрозі, остеохондрозі, грижі, протрузії, відновленні після операцій.', tags:['лікувальний','профілактика','спина'] },
    { id:'s11', name:'Вісцеральний масаж (животик)',       price:600,  time:'50 хв',      img:'assets/images/маряна.png',                             desc:'Вісцеральний масаж живота — м\'яка робота з внутрішніми органами, покращення травлення та самопочуття.', tags:['масаж','вісцеральний'] },
    ...
    { id:'s13', name:'Обгортання + Пресотерапія',          price:1100, time:'1.5 год',    img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'Комплекс: обгортання з апаратним лімфодренажним масажем — максимальний детокс-ефект.', tags:['комплекс','пресотерапія','детокс'] },
    { id:'s14', name:'Авт. детокс-скрабування MILERY',    price:1200, time:'2 год',      img:'assets/images/валентина.png',                          desc:'Авторське сольове детокс-скрабування від бренду MILERY — глибоке очищення та зволоження шкіри.', tags:['обгортання','детокс','milery'] },
    { id:'s15', name:'Обгортання MAZAKY LEYLA',            price:2000, time:'2 год',      img:'assets/images/валентина.png',                          desc:'Ексклюзивне обгортання по унікальній методиці MAZAKY LEYLA — преміальна корекційна процедура.', tags:['обгортання','mazaky','преміум'] },
    { id:'s16', name:'Обгортання Green Health',            price:800,  time:'1.5 год',    img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'Обгортання на косметиці Green Health — детоксикуючі та лікувальні властивості для тіла.', tags:['обгортання','детокс'] },
    { id:'s17', name:'Обгортання PELOVIT-R',               price:1000, time:'1.5 год',    img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'Обгортання на кульницьких грязях PELOVIT-R — потужна детокс та лікувальна дія.', tags:['обгортання','pelovit'] },
    { id:'s18', name:'Бандажне обгортання PELO VIT-R',     price:1500, time:'2 год',      img:'assets/images/валентина.png',                          desc:'Бандажне обгортання PELO VIT-R з гелями для ефективного дренування та корекції фігури.', tags:['бандажне','обгортання'] },
    { id:'s19', name:'Антицелюлітне бандажне MILERY',      price:1500, time:'2 год',      img:'assets/images/валентина.png',                          desc:'Авторське антицелюлітне бандажне обгортання від MILERY — максимальний корекційний ефект.', tags:['бандажне','антицелюліт','milery'] },
    { id:'s20', name:'Дренажне бандажне MILERY',           price:1500, time:'2 год',      img:'assets/images/валентина.png',                          desc:'Авторське дренажне бандажне обгортання MILERY — виведення рідини, зменшення набряків.', tags:['бандажне','дренаж','milery'] },
    { id:'s21', name:'Обгортання FR-HAUT',                 price:1700, time:'2 год',      img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'Обгортання на FR-HAUT — інтенсивна програма корекції, ліфтингу та відновлення шкіри.', tags:['обгортання','ліфтинг'] },
    { id:'s22', name:'Гіпсотерапія',                       price:2200, time:'2 год',      img:'assets/images/валентина.png',                          desc:'Гіпсотерапія — найпотужніша процедура корекції проблемних зон. Видимий результат після першого сеансу.', tags:['гіпсотерапія','корекція'] },
    { id:'s23', name:'Парафінотерапія BRUNOVASSARI',       price:800,  time:'1.5 год',    img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'Парафінотерапія BRUNOVASSARI — глибоке зволоження, живлення та омолодження шкіри.', tags:['парафінотерапія','зволоження'] },
    { id:'s24', name:'Обгортання + Wood масаж',            price:1200, time:'2 год',      img:'assets/images/валентина.png',                          desc:'Комплекс: обгортання + Wood масаж — подвійна дія для корекції та дренажу.', tags:['комплекс','wood','обгортання'] },
    { id:'s25', name:'Пресотерапія',                       price:450,  time:'30–50 хв',   img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'Апаратний лімфодренажний масаж для виведення токсинів, зменшення набряків та целюліту.', tags:['апаратний','пресотерапія','лімфодренаж'] },
    ...
    { id:'s27', name:'Міостимуляція (1 зона)',             price:200,  time:'20 хв',      img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'Електрична стимуляція м\'язів для тонусу, зміцнення та корекції без фізичних навантажень.', tags:['апаратний','міостимуляція'] },
    { id:'s28', name:'Карамельний масаж + обгортання',     price:1200, time:'120 хв',     img:'assets/images/валентина.png',                          desc:'Карамельний ліполіз: масаж + обгортання — розігріваючий комплекс для корекції фігури.', tags:['карамельний','ліполіз','комплекс'] },
    { id:'s29', name:'Карамельне обгортання + апаратний',  price:1200, time:'120 хв',     img:'assets/images/валентина.png',                          desc:'Карамельне обгортання з апаратним масажем — подвійна дія для розщеплення жиру.', tags:['карамельний','апаратний'] },
    ...
    { id:'s31', name:'Карамельний пілінг',                 price:400,  time:'30 хв',      img:'assets/images/Знімок екрана 2026-07-14 132337.png',   desc:'М\'яке відлущування шкіри з ефектом ліполізу — готує шкіру до процедур обгортання.', tags:['карамельний','пілінг'] },
  ...
  products: [
    { id:'p1', name:'MILERY Олія для тіла',  price:450, time:'—', img:'assets/images/лого.png', desc:'Преміальна олія для тіла від власного бренду MILERY. Зволожує та живить шкіру, надає їй сяяння та шовковистість. Натуральний склад, ніжний аромат. Ідеально підходить після масажу або обгортання.', tags:['товар','олія','milery','зволоження'] },
    { id:'p2', name:'MILERY Скраб для тіла', price:380, time:'—', img:'assets/images/лого.png', desc:'Ексфоліюючий скраб для тіла від бренду MILERY. М\'яко відлущує шкіру, надає гладкість та сяяння. Натуральний склад з морською сіллю та ефірними оліями. Готує шкіру до обгортань.', tags:['товар','скраб','milery','пілінг'] },
  ]
};
